// revolution.js OR revolution.js OR any other case file
let skinsData = null;
...
async function loadSkins() {
    try {
        ...
        skinsData = data.revolution;        // ← change to data.revolution for revolution case, etc.
    } catch (e) {
...
const CASE_COST = 2.35; // 2.25 for revolution
