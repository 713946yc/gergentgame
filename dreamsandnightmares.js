// dreamsandnightmares.js OR recoil.js OR any other case file
let skinsData = null;
...
async function loadSkins() {
    try {
        ...
        skinsData = data.dreamsandnightmares;        // ← change to data.recoil for recoil case, etc.
    } catch (e) {
...
const CASE_COST = 3.85; // 2.25 for recoil
